...
function Footer() {
  return (
    // to make this div into grid so i can give grid-col and screen bigger than smaller screen then there is two column and screen is greater than larger screen thn all come in 4
    <footer>
