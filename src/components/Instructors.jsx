...
// For Animated tooltip we need a data 
const instructors = [
  {
    id: 1,
    name: 'Elena Briggs',
  ...
  return (
    <div className="relative h-[40rem] overflow-hidden flex flex-col items-center justify-center">
      <WavyBackground>
        ...
        <p className="text-base md:text-lg text-white text-center mb-4">Discover our talented professionals who guide your musical journey.</p>
